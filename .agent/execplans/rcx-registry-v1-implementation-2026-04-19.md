...
> Status: In progress — M0 local implementation landed, external ops steps pending
...
- [ ] M3 — Publisher rights verification (3 test publishers gate; namespace classification, GitHub-passport matching, DNS TXT challenge helpers, migration, and `PublisherRightsVerified` receipt planning landed, but live OAuth/DNS/manual operator flows remain open)
